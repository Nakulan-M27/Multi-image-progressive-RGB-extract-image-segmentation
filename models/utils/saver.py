...
class Saver(object):
    ...
    def __init__(self, args):
        ...
        if args.use_wandb:
            wandb.init(
                entity="nakulanmurugan-nitt-national-institute-of-technology-tir",
                project="RGB image recognition",
    ...
    def save_checkpoint(self, state, val_loss, val_miou, filename='checkpoint.pth.tar'):
        ...
        if val_loss < self.best_loss:
            ...
            torch.save(checkpoint, os.path.join(self.save_directory, 'best_loss_{}'.format(filename)))
        ...
        if val_miou > self.best_miou:
            ...
            torch.save(checkpoint, os.path.join(self.save_directory, 'best_miou_{}'.format(filename)))
