...
def copy_files():
    ...
    source_dir = Path(r"C:\Users\10h22\OneDrive\Desktop\studies and projects\IITM intern\Programs and algorithms\RGB footprint extract\AIcrowd\Train")
    dest_dir = Path("AICrowd/train")
...
def main():
    print("Setting up AICrowd dataset...")
    ...
    print("\nSetup complete! The dataset is now in the correct location.")
